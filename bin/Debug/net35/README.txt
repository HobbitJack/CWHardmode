...
Due to using BepInEx/Harmony, it is theoretically possibled that this plugin will work as an add-on for any mod of your choosing, however please note that it has only been tested with DotMod and with only the base game.
